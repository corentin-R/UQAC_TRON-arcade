...
public class GameEntity extends Thread {
	...
	protected int sideLength;// largeur
	 ...
	 * @param num
	 */
	public GameEntity(TronGame game, int dir, Color couleur, int num,
			int x, int y) {
		xPos = x;
		yPos = y;
		xPos_init = xPos;	
	...
	/**
	 * mets à jour les coordonnées de l'entité en fonction de sa direction
	 * actuelle
	 */
	...
	/**
	 * vérifit si l'entité va mourir en regardant si les pixels devant elle sont
	 * blanc ou pas
	 * 
	 * @return true si mort
	 */
	public boolean willDie() {
		if (direction == 0
				&& !TronGame.isWhite(xPos + sideLength, yPos)// haut droite
				|| direction == 0
				&& !TronGame.isWhite(xPos + sideLength, yPos + sideLength)// bas
																			// droite
				|| direction == 180
				&& !TronGame.isWhite(xPos, yPos + sideLength)// bas gauche
				|| direction == 180
				&& !TronGame.isWhite(xPos, yPos)// haut gauche
				|| direction == 270
				&& !TronGame.isWhite(xPos, yPos + sideLength)// bas gauche
				|| direction == 270
				&& !TronGame.isWhite(xPos + sideLength, yPos + sideLength)// bas
				...
				&& !TronGame.isWhite(xPos, yPos)// haut gauche
				|| direction == 90
				&& !TronGame.isWhite(xPos + sideLength, yPos))// hut droit
			return true;
		else
			return false;
	}
